...
| :---: | :---: | :--- | :---: | :--- | :--- | :---: | :---: |
| **Tuần 1** | **Task 1.3** | Thiết lập Notebook Huấn Luyện Colab với AMP FP16 & Grad Accumulation | ☁️ **Colab T4** | • Mô hình từ Task 1.2<br>• Dữ liệu dummy từ Task 1.1 | • Notebook [`notebooks/train.ipynb`](../../../notebooks/train.ipynb)<br>• Đo đạc thời gian 1 step forward-backward | [`task_1.3_setup_colab_training_notebook.md`](task_1.3_setup_colab_training_notebook.md) | `[x] ĐÃ HOÀN THÀNH` ([Báo cáo](../../bao_cao/C/bao_cao_task_1.3_setup_colab_training_notebook.md)) |
